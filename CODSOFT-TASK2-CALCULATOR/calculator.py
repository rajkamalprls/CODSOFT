...
btnadd = Button(root,text='+',bg='#0000FF',fg='white',width=5,height=2,command=lambda :get_operator('+'))
...
btn_clr = Button(root,text='C',bg='#FF0000',fg='white',width=5,height=2,command=lambda :clear())
